...
import com.proCare.utils.selenium.DriverPool;
...
public class BaseStep {
	...
	@Before
	public void Setup() {
		String browserName = System.getenv("BROWSER") != null ? System.getenv("BROWSER")
				: Config.getProperty("BROWSER");
		String remoteURL = System.getenv("REMOTE_NODE_URL") != null ? System.getenv("REMOTE_NODE_URL")
				: Config.getProperty("REMOTE_URL");
